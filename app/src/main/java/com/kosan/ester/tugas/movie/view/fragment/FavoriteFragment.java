...
import com.kosan.ester.tugas.movie.presenter.fragment.FavoriteViewPresenter;
...
public class FavoriteFragment extends BaseFragment implements GeneralView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private FavoriteViewPresenter mFavoriteViewPresenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mFavoriteViewPresenter = new FavoriteViewPresenter(this);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Setup View
        setupToolbar(getString(R.string.title_bar_favorite));
    ...
    public void showMovie(ResponseMovie responseMovie) {
        if (adapter != null) {
            ...
            // Check No Data
            tvDesc.setText(R.string.no_favorite_text);
                ...
                rvMovies.addOnScrollListener(new RecyclerView.OnScrollListener() {
                    ...
                    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                        ...
                        if (lastItemCounter > 19 && isLoaded() && totalItemCount <= lastVisibleItem + visibleThreshold) {
                            page = counter;
                            mFavoriteViewPresenter.getAllUpFavoriteMovie(page);
                        }
                    }
                });
            }
