...
import com.kosan.ester.tugas.movie.presenter.fragment.NowPlayingViewPresenter;
...
public class NowPlayingFragment extends BaseFragment implements GeneralView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private NowPlayingViewPresenter mNowPlayingViewPresenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mNowPlayingViewPresenter = new NowPlayingViewPresenter(this);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Setup View
        setupToolbar(getString(R.string.title_bar_now_playing));
    ...
    public void loadContentError() {
        ...
        if (this.isVisible() && tvDesc != null && adapter !=null)
